...
public class PlayerControlBehaviour : MonoBehaviour
{
    ...
    //PATCH UPDATE: Power ups stopping midway is now fixed.
    void Start()
    {
    ...
    void Update()
    {
        ...
        //i dont know why unity wont see that it's using pdirection skill issue po sirs
   ...
   private void OnCollisionExit2D(Collision2D collision)
    ...
    public void LifeUpdate(int increment)
    {
        CatLives += increment;
